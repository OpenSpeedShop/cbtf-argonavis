...
/** @file Declaration of the DataTransferVisitor type. */
...
namespace ArgoNavis { namespace CUDA {
    ...
    /**
     * Type of function invoked when visiting one or more DataTransfer objects.
     * Used with implicit iterations, a reference to the DataTransfer is passed
     ...
     */
    typedef boost::function<bool (const DataTransfer&)> DataTransferVisitor;
