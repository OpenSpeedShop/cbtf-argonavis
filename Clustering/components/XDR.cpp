...
KRELL_INSTITUTE_CBTF_REGISTER_XDR_CONVERTERS(Clustering_Criterion)

KRELL_INSTITUTE_CBTF_REGISTER_XDR_CONVERTERS(ANCI_EmitPerformanceData)
KRELL_INSTITUTE_CBTF_REGISTER_XDR_CONVERTERS(ANCI_State)
KRELL_INSTITUTE_CBTF_REGISTER_XDR_CONVERTERS(ANCI_ThreadTable)
