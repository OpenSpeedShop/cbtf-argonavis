...
/** @file Declaration of the AddressRangeVisitor type. */
...
namespace ArgoNavis { namespace Base {
    ...
    /**
     * Type of function invoked when visiting one or more AddressRange objects.
     * Used with implicit iterations, a reference to the AddressRange is passed
     ...
     */
    typedef boost::function<bool (const AddressRange&)> AddressRangeVisitor;
